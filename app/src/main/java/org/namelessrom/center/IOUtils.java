...
public class IOUtils {
    ...
    public static final String DOWNLOAD_PATH = new File(Environment
            .getExternalStorageDirectory(), "Nameless/NamelessCenter/").getAbsolutePath();

    private static final String PREFIX = "nameless-";
    ...
    public static String[] getDownloadList() {
        File downloads = initSettingsHelper();
    ...
    public static String[] getDownloadSizes() {
        File downloads = initSettingsHelper();
        ArrayList<String> list = new ArrayList<String>();
        for (File f : downloads.listFiles()) {
            if (isRom(f.getName())) {
    ...
    public static String getDownloadSize(String fileName) {
        File downloads = initSettingsHelper();
        for (String file : getDownloadList()) {
    ...
    public static boolean isOnDownloadList(String fileName) {
        for (String file : getDownloadList()) {
    ...
    public static String md5(File file) {
        ...
        try {
            ...
            try {
                ...
                Logger.e(IOUtils.class, "md5", e);
            }
        }
    }

    private static File initSettingsHelper() {
        File downloads = new File(DOWNLOAD_PATH);
        downloads.mkdirs();
        return downloads;
    }
