...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private static final int[] MENU_LEFT_ICONS  = new int[]{R.drawable.ic_launcher,
            R.drawable.ic_launcher, R.drawable.ic_launcher, R.drawable.ic_launcher};
    private static final int[] MENU_LEFT_TITLES = new int[]{R.string.home, R.string.home,
            R.string.home, R.string.home};
    private static final int[] MENU_LEFT_IDS    = new int[]{Constants.MENU_ID_HOME,
            Constants.MENU_ID_HOME, Constants.MENU_ID_HOME, Constants.MENU_ID_HOME};
