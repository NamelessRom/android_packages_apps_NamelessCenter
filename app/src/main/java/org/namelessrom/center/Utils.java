...
public class Utils {
    ...
    public static final String FILES_INFO               = "org.namelessrom.center.Utils.FILES_INFO";
    public static final String CHECK_DOWNLOADS_FINISHED =
            "org.namelessrom.center.Utils.CHECK_DOWNLOADS_FINISHED";
    public static final String CHECK_DOWNLOADS_ID       =
            "org.namelessrom.center.Utils.CHECK_DOWNLOADS_ID";
    public static final String BUILD_DATE               = "ro.nameless.date";
    public static final int    ROM_ALARM_ID             = 122303221;

    public static final int TWRP      = 1;
    public static final int CWM_BASED = 2;

    public static Version[] sPackageInfosRom = new Version[0];
    private static Typeface sRobotoThin;

    public static class NotificationInfo implements Serializable {
        public int       mNotificationId;
        public Version[] mPackageInfosRom;
    }
    ...
    public static boolean setPermissions(String path, int mode, int uid, int gid) {
        try {
            ...
            return ((Integer) setPermissions.invoke(null, path, mode, uid, gid) == 0);
        } catch (Exception e) {
    ...
    public static void showNotification(Context context, Version[] infosRom) {
        ...
        if (infosRom.length == 1) {
            final String filename = infosRom[0].getReadableName();
        ...
        for (final Version version : infosRom) {
            inboxStyle.addLine(version.getReadableName());
        }
