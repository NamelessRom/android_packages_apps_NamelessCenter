...
public class DownloadService extends Service {
    ...
    public static synchronized void start(final RomUpdateCard updateCard) {
        final Intent i = new Intent(AppInstance.applicationContext, DownloadService.class);
        i.putExtra(EXTRA_ID, updateCard.getId());
        i.putExtra(EXTRA_INFO, (Parcelable) updateCard.getUpdateInfo());
